...
#The following code is written to check if the PostgreSQL database is connected properly. If not, there will be a custom error message.
def connect(): 
    try: 
        ...
        print("Error with connection to the PostgreSQL database as defined by newsdb7.py function connect in line #33")
        sys.exit(1)
#End connection function
        
#My runTheSearch function will return the results of the three main questions. In this specific instance, it will answer questions 1, 2, and 3. 
...
#Question #1: Proposes to answer the question regarding "the top three views articles in the news database." 
...
#Question #2: Proposes to answer the question concerning "the most popular authors in the news database" fetched from the total views of each news article. 
...
#Question #3: Proposes to answer the question of days with more than 1% of 404 error_days
